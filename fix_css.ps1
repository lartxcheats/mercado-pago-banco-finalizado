...
.progress-bar { width: 100%; height: 5ow: hidden; }
...
.btn-primary { background: #4361EE; color: white; border: nonefont-weight: 700; cursor: pointer; white-space: nowrap; flex-shrink: 0; font-family: 'Inter', sans-serif; letter-spacing: -0.2px; transition: opacity 0.15s; }
...
.loan-section { margin: 0 12px 12px;ay: flex; justify-content: space-between; align-items: center; }
...
.nav-item { display: flex; flex-direction: column; align-items: center; gap: 4px; background: none; border: nonefamily: 'Inter', sans-serif; transition: color 0.15s; }
...
-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 2px; box-shadow: 0 4px 14px rgba(50,188,173,0.45); }
...
.nav-circle { width: 60px; height: 60px; background: linear-gradient(135deg, #4DD4C0 0%, #2AADA0 100%); border